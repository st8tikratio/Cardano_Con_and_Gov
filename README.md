...
### ABOUT THIS REPO
- it is mainly focused on Cardano governance. There is information related to general governance as well.
- where possible documents were converted to PDF and uploaded as well as copying/pasting markdown files into this repo. This is done to maintain information in the event items 'get lost' or 'change locations.'
- source links are provided where possible.
- all copyrights are maintained by the document(s) original author(s).
...
### Final Constitution (from [Constitutional Convention](https://github.com/st8tikratio/Cardano_Con_and_Gov/blob/main/mds/cardano-con-conv.md))
